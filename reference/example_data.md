...
move2Acc provides two example datasets for working with acceleration
data. These data are publicly available and downloaded from
...
LBBG_ZEEBRUGGE. Acceleration data are provided in long format from
